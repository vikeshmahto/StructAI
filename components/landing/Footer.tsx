      ...
      <div className="landing-container">
        <div className="landing-footer-content">
          ...
          <div className="landing-footer-brand">
            <div className="landing-footer-logo">
              ...
              <span className="landing-footer-logo-text">
                Struct<span className="landing-gradient-text">AI</span>
              </span>
            </div>
            <p className="landing-footer-tagline">
              Production-level folder structures from your requirements
            </p>
          ...
          <div className="landing-footer-links">
            <div className="landing-footer-column">
              ...
              <Link href="/generate" className="landing-footer-link">
                Generator
              </Link>
            ...
            <div className="landing-footer-column">
              ...
              <Link href="#security" className="landing-footer-link">
                Security
              </Link>
            </div>
          </div>
        ...
        <div className="landing-footer-bottom">
          <p className="landing-footer-copyright">
            © {new Date().getFullYear()} StructAI. All rights reserved. | Created by Vikesh Kumar
            Mahto
          </p>
        </div>
      </div>
